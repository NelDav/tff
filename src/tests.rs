...
// ---------------------------------------------------------------------
// Node view state: horizontal text scroll, right-edge resize
// ---------------------------------------------------------------------
...
/// time with the previous chapter's end time, so a chain of Enter-on-the-
/// add-row -> set end -> Enter-on-the-add-row again should carry the end
/// forward as the next start without the user retyping it. Also verifies
/// the core ask behind this whole redesign: Enter on the "add chapter" row
